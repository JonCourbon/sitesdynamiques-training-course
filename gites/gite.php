...
<html>
	...
	<title>Gîtes de France « Luxury » | La Grange de Gazelle</title>
		...
		<div id="fh5co-intro">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 col-md-pull-2">
					<h2>La Grange de Gazelle</h2>
					<h3>Saint-Antoine-de-Ficalba - Lot-et-Garonne</h3>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-push-8 sticky-parent">
					<div class="detail" id="sticky_item">
						...
						<p><a class="btn btn-primary btn-demo" href="gites.php"></i> Revenir aux gîtes</a></p>
					</div>
				</div>
